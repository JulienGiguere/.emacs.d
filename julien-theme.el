...
(custom-theme-set-faces
 'julien
 '(default ((t (:family "Source Code Pro" :foundry "ADBO" :width normal :height 98 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "#d8d8d8" :background "#222D31" :stipple nil :inherit nil))))
 '(cursor ((t (:background "#FFFFFF"))))
 '(fixed-pitch ((t (:foreground "wheat" :family "Monospace"))))
 '(variable-pitch ((((type w32)) (:foundry "outline" :family "Arial")) (t (:family "Sans Serif"))))
 '(escape-glyph ((((background dark)) (:foreground "cyan")) (((type pc)) (:foreground "magenta")) (t (:foreground "brown"))))
 '(homoglyph ((t (:foreground "pale green"))))
 ...
 '(region ((t (:extend t :foreground "#ffffff" :background "#666"))))
 ...
 '(font-lock-comment-face ((t (:foreground "sandy brown"))))
 ...
 '(font-lock-negation-char-face ((t (:foreground "khaki1"))))
 '(font-lock-number-face ((t (:foreground "navajo white"))))
 ...
 '(font-lock-variable-use-face ((t (:inherit font-lock-variable-name-face :foreground "violet red"))))
